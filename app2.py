...
import pip
from hotel.util.util import read_yaml_file, write_yaml_file
...
from hotel.constant import CONFIG_DIR, get_current_time_stamp
from hotel.pipeline.pipeline import Pipeline
# from hotel.entity.hotel_predictor import HousingPredictor, HousingData
...
from hotel.logger import get_log_dataframe
...
def predict():
    ...
    if request.method == 'POST':
        ...
        housing_data = HeartStrokeData(longitude=longitude,
                                   latitude=latitude,
        ...
        housing_predictor = predictor(model_dir=MODEL_DIR)
